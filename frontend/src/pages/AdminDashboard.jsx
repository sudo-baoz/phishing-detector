    ...
    <div className="min-h-screen bg-black text-slate-200">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <div className="rounded-xl border p-5 bg-gray-900/50 border-gray-700">
        ...
        <div className="rounded-xl border p-5 mb-8 bg-gray-900/50 border-gray-700">
        ...
        <div className="rounded-xl border p-5 bg-gray-900/50 border-gray-700">
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 px-3 py-2 rounded-lg text-sm bg-gray-800">
              {DUMMY_API_KEY}
            </code>
            <button
              type="button"
